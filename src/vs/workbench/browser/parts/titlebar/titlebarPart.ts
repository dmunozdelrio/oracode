	...
	protected override createContentArea(parent: HTMLElement): HTMLElement {
		...
		if (hasCustomTitlebar(this.configurationService, this.titleBarStyle)) {
			...
			for (const btnInfo of buttons) {
				// append inside the action-toolbar-container to use built-in action-item styling
				const btn = append(this.actionToolBarElement, $('div.custom-hello-button.action-item', { title: btnInfo.label }));
